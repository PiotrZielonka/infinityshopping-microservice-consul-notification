...
import infinityshopping.online.app.repository.NotificationRepository;
import infinityshopping.online.app.service.dto.NotificationDTO;
import infinityshopping.online.app.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).isRead(UPDATED_IS_READ).createTime(UPDATED_CREATE_TIME);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
